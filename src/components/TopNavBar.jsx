...
const TopNavBar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-[#1d2d7d]/80 backdrop-blur-xl shadow-[0_12px_32px_rgba(29, 45, 125,0.06)]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center h-16 md:h-20">
        <Link to="/" className="flex items-center gap-2 text-xl md:gap-3 md:text-2xl font-black tracking-tighter text-[#1d2d7d] dark:text-white font-headline">
          <img
            ...
            <Link
              ...
              className={`${
                location.pathname === link.path
                  ? 'text-[#6d213a] font-extrabold'
                  : 'text-[#1d2d7d]/70 dark:text-[#f7f9fc]/70 font-bold hover:text-[#6d213a]'
        ...
        <div className="hidden lg:flex items-center gap-6">
          <button 
            ...
            className="font-bold text-[#1d2d7d]/70 dark:text-white hover:text-[#6d213a] transition-colors"
          >
            {language === 'en' ? 'FR' : 'EN'}
          </button>
        ...
        <div className="lg:hidden flex items-center gap-4">
          ...
          <button 
            ...
            translate="no" 
            className="material-symbols-outlined text-[#1d2d7d] dark:text-white text-2xl md:text-3xl"
          >
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-16 md:top-20 left-0 w-full bg-white dark:bg-[#1d2d7d] border-t border-gray-100 dark:border-gray-800 shadow-xl py-6 px-4 md:px-8 flex flex-col gap-6">
          {navLinks.map((link) => (
            <Link
              key={link.path}
              to={link.path}
              ...
              className={`${
                location.pathname === link.path
                  ? 'text-[#6d213a] font-extrabold'
                  : 'text-[#1d2d7d]/70 dark:text-[#f7f9fc]/70 font-bold'

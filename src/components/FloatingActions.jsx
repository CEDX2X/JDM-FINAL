    ...
    <>
      <div className="fixed bottom-6 left-6 z-[100] flex flex-col gap-4">
        {!isHome && (
          <button
            onClick={() => navigate(-1)}
            className="w-12 h-12 bg-surface-container-lowest border border-outline-variant/20 rounded-full shadow-[0_8px_24px_rgba(11,29,58,0.1)] flex items-center justify-center text-primary dark:text-white hover:bg-surface-container-low hover:scale-110 transition-all duration-300 group"
            aria-label="Retour"
          >

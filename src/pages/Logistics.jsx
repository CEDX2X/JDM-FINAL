    ...
    <div className="bg-surface">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden border-b border-outline-variant/10">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 text-center max-w-4xl">
          ...
          <p className="text-xl text-on-surface-variant dark:text-white mb-8 md:mb-12 leading-relaxed max-w-2xl mx-auto font-body">
            {t('log.desc')}
          </p>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-8 mt-10 md:mt-20">
          <div className="bg-surface-container-lowest rounded-2xl md:rounded-3xl p-5 md:p-8 flex flex-col md:flex-row justify-between items-center shadow-2xl border border-outline-variant/10 divide-y md:divide-y-0 md:divide-x divide-outline-variant/20">
            <div className="px-4 md:px-8 py-4 md:py-0 text-center w-full">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/70">Countries Served</span>
            </div>
            <div className="px-4 md:px-8 py-4 md:py-0 text-center w-full">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/70">Suivi personnalisé</span>
            </div>
            <div className="px-4 md:px-8 py-4 md:py-0 text-center w-full">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/70 block">{t('log.live_desc')}</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-surface-container-lowest p-10 rounded-[2rem] border border-outline-variant/10 hover:shadow-xl transition-shadow group">
              ...
              <p className="text-on-surface-variant dark:text-white leading-relaxed mb-6 block border-b border-outline-variant/10 pb-6">{t('log.int_desc')}</p>
            ...
            <div className="bg-surface-container-lowest p-10 rounded-[2rem] border border-outline-variant/10 hover:shadow-xl transition-shadow group">
              ...
              <p className="text-on-surface-variant dark:text-white leading-relaxed mb-6 block border-b border-outline-variant/10 pb-6">{t('log.fleet')} 99% {t('log.rate_title')}</p>
              <ul className="space-y-3">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-16 items-center">
              ...
              <div className="space-y-8 mt-10">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-on-surface-variant dark:text-white leading-relaxed">{t('log.m1_desc')}</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="w-12 h-12 rounded-full bg-surface-container-lowest flex items-center justify-center shadow-sm flex-shrink-0 text-secondary dark:text-secondary-fixed border border-outline-variant/10">
                  ...
                  <div>
                    ...
                    <p className="text-on-surface-variant dark:text-white leading-relaxed">{t('log.m2_desc')}</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="w-12 h-12 rounded-full bg-surface-container-lowest flex items-center justify-center shadow-sm flex-shrink-0 text-secondary dark:text-secondary-fixed border border-outline-variant/10">
                  ...
                  <div>
                    ...
                    <p className="text-on-surface-variant dark:text-white leading-relaxed">{t('log.m3_desc')}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 w-full relative">
              ...
              <div className="w-full h-64 md:h-96 lg:h-[600px] relative z-10 cursor-pointer overflow-hidden rounded-[3rem] shadow-2xl group" onClick={handleSlideChange} title="Cliquez pour changer l'image">
                {slideImages.map((src, index) => (
                  <img key={index} className={`absolute inset-0 w-full h-full object-cover transition-all duration-700 ease-in-out ${index === activeSlide ? 'opacity-100 scale-100 z-10' : 'opacity-0 scale-105 z-0'}`} src={src} alt={`Logistics facility view ${index + 1}`} />
                ))}
              ...
              <div className="absolute top-1/2 right-0 translate-x-1/4 -translate-y-1/2 bg-surface-container-lowest p-6 rounded-2xl shadow-2xl z-20 w-48 text-center border border-outline-variant/10">
                ...
                <span className="text-xs font-medium text-on-surface-variant dark:text-white">Seamless ERP Integration</span>
              </div>
            </div>
          </div>
        </div>

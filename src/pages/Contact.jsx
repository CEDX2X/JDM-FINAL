  ...
  return (
    <main className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
      <header className="mb-8 md:mb-16 lg:mb-24">
        <h1 className="text-2xl md:text-3xl md:text-4xl lg:text-5xl lg:text-7xl font-extrabold tracking-tighter text-primary dark:text-white mb-4">{t('contact.title')}</h1>
        <p className="text-on-surface-variant dark:text-white max-w-2xl text-lg leading-relaxed font-body">
          {t('contact.desc')}
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start">
        ...
        <section className="lg:col-span-7 bg-surface-container-low rounded-[2rem] p-6 md:p-8 lg:p-12 shadow-sm relative overflow-hidden">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-primary dark:text-white mb-8">{t('contact.msg')}</h2>
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/60 ml-1">{t('contact.name')}</label>
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/60 ml-1">{t('contact.email')}</label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/60 ml-1">{t('contact.subject')}</label>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/60 ml-1">{t('contact.your_msg')}</label>
        ...
        <aside className="lg:col-span-5 space-y-8">
          ...
          <div className="bg-surface-container-lowest rounded-[2rem] p-5 md:p-8 shadow-[0_12px_32px_rgba(11,29,58,0.04)] group">
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-sm font-bold uppercase tracking-widest text-on-surface-variant dark:text-white/60 mb-2">{t('contact.hq')}</h3>
                <p className="text-xl font-bold text-primary dark:text-white leading-tight" dangerouslySetInnerHTML={{ __html: t('contact.hq_addr') }}></p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-low rounded-[2rem] p-5 md:p-8 space-y-6">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="font-bold text-primary dark:text-white">+237696464712 - +237657052145</p>
              </div>
            </div>
            <div className="flex items-center gap-6">
              <div className="w-12 h-12 rounded-full bg-primary-container flex items-center justify-center text-white">
              ...
              <div>
                ...
                <p className="font-bold text-primary dark:text-white">jdmtravel@outlook.com</p>
              </div>
            </div>
          </div>
          {/* Map Placeholder */}
      ...
      <section className="mt-12 md:mt-24 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-5 md:p-8 bg-surface-container-lowest border-l-4 border-secondary rounded-xl">
          <h4 className="font-bold text-primary dark:text-white mb-2">{t('contact.corp')}</h4>
          <p className="text-sm text-on-surface-variant dark:text-white">{t('contact.corp_desc')}</p>
        </div>
        <div className="p-5 md:p-8 bg-surface-container-lowest border-l-4 border-primary-container rounded-xl">
          <h4 className="font-bold text-primary dark:text-white mb-2">{t('contact.priv')}</h4>
          <p className="text-sm text-on-surface-variant dark:text-white">{t('contact.priv_desc')}</p>
        </div>
        <div className="p-5 md:p-8 bg-surface-container-lowest border-l-4 border-secondary-container rounded-xl">
          <h4 className="font-bold text-primary dark:text-white mb-2">{t('contact.sup')}</h4>
          <p className="text-sm text-on-surface-variant dark:text-white">{t('contact.sup_desc')}</p>
        </div>
      </section>
    </main>
  );

      ...
      <section className="relative h-screen flex border-b border-outline-variant/20">
        <div className="w-full lg:w-1/2 flex items-center px-4 md:px-8 lg:px-20 relative z-10 bg-surface/90 backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none">
          <div className="max-w-xl">
            ...
            <p className="text-xl text-on-surface-variant dark:text-surface-variant mb-8 md:mb-12 leading-relaxed font-body">
              {t('travel.desc')}
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-surface-container-lowest/90 backdrop-blur p-6 rounded-2xl shadow-2xl flex items-center gap-4 border border-outline-variant/20">
                ...
                <div>
                  <p className="text-xs text-on-surface-variant dark:text-surface-variant uppercase tracking-widest font-bold">24/7 {t('travel.routes')}</p>
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              ...
              <p className="text-on-surface-variant dark:text-surface-variant text-lg mb-10 leading-relaxed">
                {t('travel.prec_desc')}
              </p>
              ...
              <ul className="space-y-8">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-on-surface-variant dark:text-surface-variant space-y-2 list-none">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center md:text-left flex flex-col md:flex-row justify-between items-end mb-8 md:mb-16 gap-6 md:gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-on-surface-variant dark:text-surface-variant text-lg">{t('travel.curated_desc')}</p>
            </div>
          </div>

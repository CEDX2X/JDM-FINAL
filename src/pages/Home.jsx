        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-8 md:mb-16 gap-6 md:gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-on-surface-variant dark:text-white text-lg leading-relaxed font-body">{t('home.services.desc')}</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            <div className="md:col-span-8 group relative overflow-hidden rounded-xl bg-surface-container-lowest transition-all hover:shadow-2xl">
              ...
              <div className="p-5 md:p-8">
                ...
                <p className="text-on-surface-variant dark:text-white mb-8 max-w-xl">{t('home.services.travelDesc')}</p>
            ...
            <div className="md:col-span-4 group relative overflow-hidden rounded-xl bg-surface-container-lowest transition-all hover:shadow-2xl">
              ...
              <div className="p-5 md:p-8">
                ...
                <p className="text-on-surface-variant dark:text-white mb-8">{t('home.services.importDesc')}</p>
      ...
      <section className="py-16 lg:py-32 bg-surface-container-low">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-10 md:mb-20">
            ...
            <p className="text-on-surface-variant dark:text-white text-xl max-w-2xl mx-auto">{t('home.why.desc')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-12">
            <div className="text-center p-5 md:p-8">
              ...
              <p className="text-on-surface-variant dark:text-white leading-relaxed">{t('home.why.trustDesc')}</p>
            </div>
            <div className="text-center p-5 md:p-8">
              <div className="w-20 h-16 md:h-20 bg-surface-container-lowest rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-sm">
              ...
              <p className="text-on-surface-variant dark:text-white leading-relaxed">{t('home.why.agilityDesc')}</p>
            </div>
            <div className="text-center p-5 md:p-8">
              <div className="w-20 h-16 md:h-20 bg-surface-container-lowest rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-sm">
              ...
              <p className="text-on-surface-variant dark:text-white leading-relaxed">{t('home.why.supportDesc')}</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="bg-surface-container-low p-6 md:p-10 rounded-xl relative">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-on-surface-variant dark:text-white">{t('home.testimonials.p1')}</p>
                  </div>
                </div>
              </div>
              <div className="bg-surface-container-low p-6 md:p-10 rounded-xl relative">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-on-surface-variant dark:text-white">{t('home.testimonials.p2')}</p>
                  </div>
                </div>
              </div>
            </div>
